...
Ndes = 25000                          # Rotational speed [rpm]     
...
# Fluid properties  
global R, k, Cp                         # Low risk globally declared variables
...
r1Dr2 = 0.45                                # rt1 divided by rt2 ,making rt2 increase through array progression
...
plt.figure('W1 plot')
# plt.plot(Cm1i, W1tIter, 'ro')
plt.plot(Cm1i, W1ti, '-r')
plt.xlabel("Cm1 (m/s)")
plt.ylabel("W1t (m/s)")
plt.grid()
